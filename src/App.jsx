  ...
  return (
    <Router>
      ...
      {  <div className='whatsapp'>
        ...
        {/* 923428347762 */}
        <a className='mx-3' target="_blank" aria-label="Chat on WhatsApp" href="https://wa.me/923428347762?text="> <i style={{ color: '#0dc143' }} className="fa fa-whatsapp" aria-hidden="true"></i> </a>
      </div> }
